...
; Il vettore delle interruzioni NON contiene il reset, che iar
; forza in flash, per cui tutti gli handler possono stare in ram
        ...
        SECTION .ram_irq:DATA:ROOT(2)

        PUBLIC  __nome_inutile

        DATA
__nome_inutile
        DCD     sfe(CSTACK)						  ; serve a freertos
        DCD     0                                 ; Reset Handler
