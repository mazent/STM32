...
// MZ From: linux-4.8.12\include\list.h

// MZ #include <linux/types.h>
// MZ #include <linux/stddef.h>
// MZ #include <linux/poison.h>
// MZ #include <linux/const.h>
// MZ #include <linux/kernel.h>
...
/*
 * Dato il puntatore ad un membro di una struttura,
 * restituisce un puntatore alla struttura che lo contiene
 *
 * type {
 *      tipo1 nome1 ;
 *      ...
...
{
    __list_add(nuova, head, head->next) ;
}
...
static inline void list_add_tail(
    ...
    struct list_head * head)
{
    __list_add(nuova, head->prev, head) ;
}
 ...
 * @nuova : the new element to insert
 *
 ...
 */
static inline bool list_is_last(
